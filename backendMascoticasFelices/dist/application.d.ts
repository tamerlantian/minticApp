...
declare const Mascoticasfelicesv2Application_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class Mascoticasfelicesv2Application extends Mascoticasfelicesv2Application_base {
